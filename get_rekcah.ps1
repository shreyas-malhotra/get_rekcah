...
Invoke-WebRequest https://www.blackhillsinfosec.com/wp-content/uploads/2022/02/Zine_FINAL_all_pages.pdf -OutFile "REKCAH: The Future Is ****** - Ashcan Edition Preview"
